Feature: Amazon
  Scenario: Add products to the shopping cart
    ...
    And User opens details of product number '5' from the list
    And User adds '3' pieces of the product to the shopping cart and gets the name and price of the product
